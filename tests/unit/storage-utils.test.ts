...
describe(
    'The Storage-Utils should allow storage of items and access to stored items', () => {
        ...
        it(
            'should insert data successfully into a namespace', async () => {
                const storage = new ObjectStorage<TestType>;
                ...
                const result = storage.collections(
                    'TEST_NAMESPACE_0'
                );
                ...
                const value = result[0] as CollectionList;
        ...
        it(
            'should not overwrite current namespace/collection data with duplicate items', () => {
                const storage = new ObjectStorage<TestType>;
                ...
                expect(
                    storage.search(
                        'TEST_NAMESPACE_0', 'TEST_COLLECTION_1'
                    ).items
                ).toEqual(
                    [
                        {
        ...
        it(
            'should be able to handle specific item expiration', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should report a 404 if all items have expired in collection', async () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should be able to search a namespace to return a collection', async () => {
                const storage = new ObjectStorage<TestType>;
                ...
                const list0Result = storage.collections(
                    'TEST_NAMESPACE_0'
                );
                ...
                const result0 = storage.search(
                    'TEST_NAMESPACE_0', 'TEST_COLLECTION_0'
                );

                expect(
                    result0.items.length
                ).toEqual(
                    4
                );
                expect(
                ...
                const list1Result = storage.collections(
                    'TEST_NAMESPACE_1'
                );
                ...
                const result1 = storage.search(
                    'TEST_NAMESPACE_1', 'TEST_COLLECTION_0'
                );
        ...
        it(
            'should return items in order of stored time', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should order items correctly, new values should be first in the list', async () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should order items correctly, and add a date if it\'s missing', async () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should return all items in an ordered list', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should be able to find a specific item in a namespace by its ID', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should report a 404 when no item is found when searching an item by its ID', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should chunk a response as required', () => {
                const storage = new ObjectStorage<TestType>;
        ...
        it(
            'should return an error if no results were found for that page', () => {
                const storage = new ObjectStorage<TestType>;
